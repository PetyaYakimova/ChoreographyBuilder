...
public class VerseChoreographyFigureExistsForThisUserAttribute : ActionFilterAttribute
{
    public override void OnActionExecuting(ActionExecutingContext context)
    {
        ...
        if (value != null)
        {
            ...
            {
                if (service != null && service.VerseChoreographyFigureExistForThisUserByIdAsync(id, context.HttpContext.User.Id()).Result == false)
                {
