...
public class VerseChoreographyExistsForThisUserAttribute : ActionFilterAttribute
{
	public override void OnActionExecuting(ActionExecutingContext context)
	{
		...
		if (value != null)
		{
			...
			{
				if (service != null && service.VerseChoreographyExistForThisUserByIdAsync(id, context.HttpContext.User.Id()).Result == false)
				{
