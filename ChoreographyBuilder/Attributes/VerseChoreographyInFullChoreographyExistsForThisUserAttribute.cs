...
{
	public class VerseChoreographyInFullChoreographyExistsForThisUserAttribute : ActionFilterAttribute
	{
		public override void OnActionExecuting(ActionExecutingContext context)
		{
			...
			if (value != null)
			{
				...
				{
					if (service != null && service.VerseChoreographyInFullChoreographyExistForThisUserByIdAsync(id, context.HttpContext.User.Id()).Result == false)
					{
