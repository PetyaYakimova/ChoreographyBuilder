...
public class VerseChoreographyFigureServiceTests : UnitTestsBase
{
    ...
    [Test]
    public async Task FigureIsLastForVerseChoreographyByIdAsync_ShouldReturnFalseForInvalidId()
    {
    ...
    [Test]
    public void AddFigureToVerseChoreography_ShouldThrowExceptionWhenFigureOptionDoesntExists()
    {
        VerseChoreographyFigureOptionFormViewModel model = new()
        {
            FigureOptionId = 200,
