...
public class VerseChoreographyServiceTests : UnitTestsBase
{
    ...
    [Test]
    public void IsVerseChoreographyComplete_ShouldThrowAnExceptionIfTheVerseChoreographyDoesntExist()
    {
        Assert.That(async () => await verseChoreographyService.IsVerseChoreographyCompleteAsync(10),
            Throws.Exception.TypeOf<EntityNotFoundException>());
    }
    ...
    [Test]
    public async Task IsVerseChoreographyForFigureComplete_ShouldReturnFalseWhenTheVerseChoreographyIsNotComplete()
    {
        var result = await verseChoreographyService.IsVerseChoreographyForFigureCompleteAsync(SecondVerseChoreographyFirstFigure.Id);
